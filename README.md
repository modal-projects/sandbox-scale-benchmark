...
If `--total` is more than 2x of the largest prior run under `results/` that
completed, or above 500 when there was no prior run, the orchestrator asks you
to confirm a smaller load before running.
